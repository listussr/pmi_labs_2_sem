...
//
//enum Syntax_state {
//	Start, If_key_word, Identificator_1,
//	Ao_1, Value_1, Compare, Value_2, Else_key_word, Then_key_word, Identificator_2,
//	Identificator_3, Ao_3, Value_3, Value_4, Identificator_4, Ao_2, F, ERROR, END,
//	Unary_minus_1, Unary_minus_2, Unary_minus_3, Unary_minus_4, Unary_minus_5,
//	Unary_minus_6, Extra_Identificator_1, Extra_Identificator_2
//};
//
///*
...
//9 - + | * | / - ao
//10 - wrong lex - wl
//11 - # - sharp // дл€ обозначени€ конца вектора лексем
//12 - - - minus - дл€ знака минуса
//*/
//
//enum State // состо€ни€ автомата
//{
...
//}
//
//void Filling_Syntax_automat_table(Syntax_state(&table)[27][12]) {
//	// дл€ Start
...
//	table[Syntax_state::If_key_word][id] = Syntax_state::Identificator_1;
//	table[Syntax_state::If_key_word][vl] = Syntax_state::Value_2;
//	table[Syntax_state::If_key_word][co] = Syntax_state::ERROR;
//	table[Syntax_state::If_key_word][ao] = Syntax_state::ERROR;
//	table[Syntax_state::If_key_word][minus] = Syntax_state::Unary_minus_1;
...
//
//	// дл€ Unary_minus
//	table[Syntax_state::Unary_minus_1][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_1][th] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_1][el] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_1][en] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_1][id] = Syntax_state::Identificator_1;
//	table[Syntax_state::Unary_minus_1][vl] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_1][co] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_1][ao] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_1][minus] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_1][eq] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_1][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_1][sharp] = Syntax_state::ERROR;
//
//	// дл€ Id_1
//	table[Syntax_state::Identificator_1][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_1][th] = Syntax_state::Then_key_word;
//	table[Syntax_state::Identificator_1][el] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_1][en] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_1][id] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_1][vl] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_1][co] = Syntax_state::Compare;
//	table[Syntax_state::Identificator_1][ao] = Syntax_state::Ao_1;
//	table[Syntax_state::Identificator_1][minus] = Syntax_state::Ao_1;
//	table[Syntax_state::Identificator_1][eq] = Syntax_state::Compare;
//	table[Syntax_state::Identificator_1][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_1][sharp] = Syntax_state::ERROR;
//
//	// дл€ Ao_1
//	table[Syntax_state::Ao_1][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_1][th] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_1][el] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_1][en] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_1][id] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_1][vl] = Syntax_state::Value_1;
//	table[Syntax_state::Ao_1][co] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_1][ao] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_1][minus] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_1][eq] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_1][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_1][sharp] = Syntax_state::ERROR;
//
//	// дл€ Vl_1
//	table[Syntax_state::Value_1][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Value_1][th] = Syntax_state::ERROR;
//	table[Syntax_state::Value_1][el] = Syntax_state::ERROR;
//	table[Syntax_state::Value_1][en] = Syntax_state::ERROR;
//	table[Syntax_state::Value_1][id] = Syntax_state::ERROR;
//	table[Syntax_state::Value_1][vl] = Syntax_state::ERROR;
//	table[Syntax_state::Value_1][co] = Syntax_state::Compare;
//	table[Syntax_state::Value_1][ao] = Syntax_state::Compare;
//	table[Syntax_state::Value_1][minus] = Syntax_state::Ao_1;
//	table[Syntax_state::Value_1][eq] = Syntax_state::ERROR;
//	table[Syntax_state::Value_1][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Value_1][sharp] = Syntax_state::ERROR;
//
//	// дл€ Comp
...
//	table[Syntax_state::Compare][id] = Syntax_state::Identificator_1;
//	table[Syntax_state::Compare][vl] = Syntax_state::Value_2;
//	table[Syntax_state::Compare][co] = Syntax_state::ERROR;
//	table[Syntax_state::Compare][ao] = Syntax_state::ERROR;
//	table[Syntax_state::Compare][minus] = Syntax_state::Unary_minus_2;
...
//
//	// дл€ Unary_minus_2
//	table[Syntax_state::Unary_minus_2][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_2][th] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_2][el] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_2][en] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_2][id] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_2][vl] = Syntax_state::Value_2;
//	table[Syntax_state::Unary_minus_2][co] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_2][ao] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_2][minus] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_2][eq] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_2][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_2][sharp] = Syntax_state::ERROR;
//
//	// дл€ Value_2
//	table[Syntax_state::Value_2][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Value_2][th] = Syntax_state::Then_key_word;
//	table[Syntax_state::Value_2][el] = Syntax_state::ERROR;
//	table[Syntax_state::Value_2][en] = Syntax_state::ERROR;
//	table[Syntax_state::Value_2][id] = Syntax_state::ERROR;
//	table[Syntax_state::Value_2][vl] = Syntax_state::ERROR;
//	table[Syntax_state::Value_2][co] = Syntax_state::ERROR;
//	table[Syntax_state::Value_2][ao] = Syntax_state::ERROR;
//	table[Syntax_state::Value_2][minus] = Syntax_state::ERROR;
//	table[Syntax_state::Value_2][eq] = Syntax_state::ERROR;
//	table[Syntax_state::Value_2][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Value_2][sharp] = Syntax_state::ERROR;
//
//	// дл€ Then
...
//	table[Syntax_state::Then_key_word][id] = Syntax_state::Identificator_2;
...
//	table[Syntax_state::Then_key_word][minus] = Syntax_state::Unary_minus_3;
...
//	table[Syntax_state::Unary_minus_3][id] = Syntax_state::Identificator_2;
//	table[Syntax_state::Unary_minus_3][vl] = Syntax_state::ERROR;
...
//
//	// дл€ Identificator_2
//	table[Syntax_state::Identificator_2][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_2][th] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_2][el] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_2][en] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_2][id] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_2][vl] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_2][co] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_2][ao] = Syntax_state::Ao_2;
//	table[Syntax_state::Identificator_2][minus] = Syntax_state::Ao_2;
//	table[Syntax_state::Identificator_2][eq] = Syntax_state::Ao_2;
//	table[Syntax_state::Identificator_2][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_2][sharp] = Syntax_state::ERROR;
//
//	// дл€ Ao_2
//	table[Syntax_state::Ao_2][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_2][th] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_2][el] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_2][en] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_2][id] = Syntax_state::Extra_Identificator_1;
//	table[Syntax_state::Ao_2][vl] = Syntax_state::Value_3;
//	table[Syntax_state::Ao_2][co] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_2][ao] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_2][minus] = Syntax_state::Unary_minus_4;
//	table[Syntax_state::Ao_2][eq] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_2][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_2][sharp] = Syntax_state::ERROR;
//
//	// дл€ Extra_Identificator_1
//	table[Syntax_state::Extra_Identificator_1][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Extra_Identificator_1][th] = Syntax_state::ERROR;
//	table[Syntax_state::Extra_Identificator_1][el] = Syntax_state::Else_key_word;
//	table[Syntax_state::Extra_Identificator_1][en] = Syntax_state::F;
//	table[Syntax_state::Extra_Identificator_1][id] = Syntax_state::ERROR;
//	table[Syntax_state::Extra_Identificator_1][vl] = Syntax_state::ERROR;
//	table[Syntax_state::Extra_Identificator_1][co] = Syntax_state::ERROR;
//	table[Syntax_state::Extra_Identificator_1][ao] = Syntax_state::Ao_2;
//	table[Syntax_state::Extra_Identificator_1][minus] = Syntax_state::Ao_2;
//	table[Syntax_state::Extra_Identificator_1][eq] = Syntax_state::ERROR;
//	table[Syntax_state::Extra_Identificator_1][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Extra_Identificator_1][sharp] = Syntax_state::ERROR;
//
//	// дл€ Unary_minus_4
//	table[Syntax_state::Unary_minus_4][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_4][th] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_4][el] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_4][en] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_4][id] = Syntax_state::Value_3;
//	table[Syntax_state::Unary_minus_4][vl] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_4][co] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_4][ao] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_4][minus] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_4][eq] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_4][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_4][sharp] = Syntax_state::ERROR;
//
//	// дл€ Value_3
//	table[Syntax_state::Value_3][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Value_3][th] = Syntax_state::ERROR;
//	table[Syntax_state::Value_3][el] = Syntax_state::Else_key_word;
//	table[Syntax_state::Value_3][en] = Syntax_state::F;
//	table[Syntax_state::Value_3][id] = Syntax_state::ERROR;
//	table[Syntax_state::Value_3][vl] = Syntax_state::ERROR;
//	table[Syntax_state::Value_3][co] = Syntax_state::ERROR;
//	table[Syntax_state::Value_3][ao] = Syntax_state::Ao_2;
//	table[Syntax_state::Value_3][minus] = Syntax_state::Ao_2;
//	table[Syntax_state::Value_3][eq] = Syntax_state::ERROR;
//	table[Syntax_state::Value_3][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Value_3][sharp] = Syntax_state::ERROR;
//
//	// дл€ Else
...
//	table[Syntax_state::Else_key_word][id] = Syntax_state::Identificator_3;
...
//	table[Syntax_state::Else_key_word][minus] = Syntax_state::Unary_minus_5;
...
//	table[Syntax_state::Unary_minus_5][id] = Syntax_state::Identificator_3;
//	table[Syntax_state::Unary_minus_5][vl] = Syntax_state::ERROR;
...
//
//	// дл€ Id_3
//	table[Syntax_state::Identificator_3][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_3][th] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_3][el] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_3][en] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_3][id] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_3][vl] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_3][co] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_3][ao] = Syntax_state::Ao_3;
//	table[Syntax_state::Identificator_3][minus] = Syntax_state::Ao_3;
//	table[Syntax_state::Identificator_3][eq] = Syntax_state::Ao_3;
//	table[Syntax_state::Identificator_3][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Identificator_3][sharp] = Syntax_state::ERROR;
//
//	// дл€ Ao_3
//	table[Syntax_state::Ao_3][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_3][th] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_3][el] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_3][en] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_3][id] = Syntax_state::Extra_Identificator_2;
//	table[Syntax_state::Ao_3][vl] = Syntax_state::Value_4;
//	table[Syntax_state::Ao_3][co] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_3][ao] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_3][minus] = Syntax_state::Unary_minus_6;
//	table[Syntax_state::Ao_3][eq] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_3][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Ao_3][sharp] = Syntax_state::ERROR;
//
//	// дл€ Extra_Identificator_2
//	table[Syntax_state::Extra_Identificator_2][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Extra_Identificator_2][th] = Syntax_state::ERROR;
//	table[Syntax_state::Extra_Identificator_2][el] = Syntax_state::ERROR;
//	table[Syntax_state::Extra_Identificator_2][en] = Syntax_state::F;
//	table[Syntax_state::Extra_Identificator_2][id] = Syntax_state::ERROR;
//	table[Syntax_state::Extra_Identificator_2][vl] = Syntax_state::ERROR;
//	table[Syntax_state::Extra_Identificator_2][co] = Syntax_state::ERROR;
//	table[Syntax_state::Extra_Identificator_2][ao] = Syntax_state::Ao_3;
//	table[Syntax_state::Extra_Identificator_2][minus] = Syntax_state::Ao_3;
//	table[Syntax_state::Extra_Identificator_2][eq] = Syntax_state::ERROR;
//	table[Syntax_state::Extra_Identificator_2][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Extra_Identificator_2][sharp] = Syntax_state::ERROR;
//
//	// дл€ Unary_minus_6
//	table[Syntax_state::Unary_minus_6][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_6][th] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_6][el] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_6][en] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_6][id] = Syntax_state::Value_4;
//	table[Syntax_state::Unary_minus_6][vl] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_6][co] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_6][ao] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_6][minus] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_6][eq] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_6][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Unary_minus_6][sharp] = Syntax_state::ERROR;
//
//	// дл€ Vl_4
//	table[Syntax_state::Value_4][_if] = Syntax_state::ERROR;
//	table[Syntax_state::Value_4][th] = Syntax_state::ERROR;
//	table[Syntax_state::Value_4][el] = Syntax_state::ERROR;
//	table[Syntax_state::Value_4][en] = Syntax_state::F;
//	table[Syntax_state::Value_4][id] = Syntax_state::ERROR;
//	table[Syntax_state::Value_4][vl] = Syntax_state::ERROR;
//	table[Syntax_state::Value_4][co] = Syntax_state::ERROR;
//	table[Syntax_state::Value_4][ao] = Syntax_state::Ao_3;
//	table[Syntax_state::Value_4][minus] = Syntax_state::ERROR;
//	table[Syntax_state::Value_4][eq] = Syntax_state::ERROR;
//	table[Syntax_state::Value_4][wl] = Syntax_state::ERROR;
//	table[Syntax_state::Value_4][sharp] = Syntax_state::ERROR;
//
//	// дл€ ERROR
...
//}
//
//int Get_File_size(ifstream& in) { // узнаЄм размер файла
...
//		return id;
//	else if (st == Id_2) // правер€ем на соответствие ключевым словам
...
//			res.push_back(lex);
//			counter_prev = (ptr == ' ' || ptr == '\t' || ptr == '\n' ? counter + 1 : counter); // дл€ недопуска разделителей в лексемму
...
//}
//
//void ERROR_Detected(vector<Lex>::size_type ind, ofstream& out, vector<Lex>::size_type i) { // переделываем
//	const char* list_of_types[] = { "if", "id", "eq", "vl", "th", "id", "ao", "vl", "el", "id", "ao", "vl", "en", "sharp", "minus" };
//	out << i << ' ';
//	out << ((ind == 7 ? list_of_types[12] : list_of_types[ind]));
//}
//
//void Syntax_analysis(vector<Lex>& vec, Syntax_state table[27][12], ofstream& out) {
//	vector<Lex>::size_type ind{ 0 }, divisible{ 0 };
//	const int divider = 13;
//	Syntax_state cur = Syntax_state::Start;
//	lex_type prev;
//	bool flag{ true };
//	while (vec.size() - ind) {
//		divisible = ind % divider;
//		prev = vec[ind].type;
//		cur = table[cur][vec[ind++].type];
//		if (!(cur - Syntax_state::ERROR) && flag) {
//			ERROR_Detected(divisible, out, ind - 1);
//			flag = false;
//		}
//	}
//	if (flag)
...
//	vector<Lex> res;
//	State table[15][25];
//	Syntax_state syntax_table[27][12];
